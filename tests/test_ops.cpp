...
TEST(Ops, Coefficients) {
  ...
  EXPECT_DOUBLE_EQ(TanhOp::derivative<double>(0.5),
                   1.0 - std::tanh(0.5) * std::tanh(0.5));
  EXPECT_DOUBLE_EQ(TanOp::derivative<double>(0.5),
                   1.0 / (std::cos(0.5) * std::cos(0.5)));
  ...
  EXPECT_DOUBLE_EQ(CbrtOp::derivative<double>(8.0),
                   1.0 / (3.0 * std::cbrt(8.0) * std::cbrt(8.0)));
  ...
  EXPECT_DOUBLE_EQ(Log10Op::derivative<double>(2.0),
                   1.0 / (2.0 * std::log(10.0)));

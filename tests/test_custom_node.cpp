...
TEST(CustomNode, MetadataVerification) {
    ...
    EXPECT_NE(std::find(std::begin(expected), std::end(expected), p0), std::end(expected));
    EXPECT_NE(std::find(std::begin(expected), std::end(expected), p1), std::end(expected));
    EXPECT_NE(std::find(std::begin(expected), std::end(expected), p2), std::end(expected));
}
